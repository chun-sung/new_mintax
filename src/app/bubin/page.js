...
export default function Bubin() {
  return <>
   ...
   <PageTop />        
   <h1 className="text-center pt-[120px] lg:pt-[200px] text-2xl stop-dragging">법인 컨설팅</h1>
      ...
      <div className="flex flex-wrap -m-4">
        <div className="p-4 lg:w-1/3">
          <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
            ...
            <h1 className="title-font sm:text-xl text-xl font-medium text-gray-800 mb-3">Raclette Blueberry Nextious Level</h1>
