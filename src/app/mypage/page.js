...
export default function Mypage() {
    ...
    return <>
        ...
        <PageTop />  
        <h1 className="text-center pt-[130px] lg:pt-[130px] text-2xl text-red-500 font-extrabold stop-dragging">MyPage</h1>
        <h1 className="text-center mt-10 text-2xl font-semibold"><span className="text-blue-500 stop-dragging">{user.user_id}</span> 님 Welcome!</h1>
