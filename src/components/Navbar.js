  ...
  return (<>
    ...
    <div className={mode !== 'darkMode' ? "relative h-[60px] lg:h-[75px] w-full m-auto bg-white border-b border-gray" :
        ...
        <div className="relative m-auto w-[80px] pt-2.5 lg:pt-5">
            ...
            { user.user_id !== null ?
              <span className="absolute lg:hidden bottom-[-1px] left-[135px] lg:left-[430px] text-blue-500 
        ...
        }
        {
          ...
          <button onClick={()=>{
            ...
            className="border-[1px] border-slate-700 shadow-md border-black border-[1px] lg:border-[1px] mt-5 lg:mt-0 text-[16px] lg:text-[14px] rounded-r-xl
                     bg-slate-600 lg:bg-slate-900 text-white h-[27px] px-4 p-0 leading-[25px] lg:hover:bg-slate-700"
            >logout
            </button>
          :<>
