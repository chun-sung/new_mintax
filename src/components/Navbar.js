        ...
        }
        {
          ...
          <button onClick={()=>{
            ...
            className="border-[1px] border-slate-700 shadow-md border-black border-[1px] lg:border-[1px] mt-5 lg:mt-0 text-[16px] lg:text-[14px] rounded-r-xl
                     bg-slate-600 lg:bg-slate-900 text-white h-[27px] px-4 p-0 leading-[23px] lg:leading-[28px] lg:hover:bg-slate-700"
            >logout
            </button>
          :<>
            <button onClick={()=> { dispatch(SET_LOGIN_WINDOW(true));dispatch(SET_MENU_BTN(false));dispatch(SET_MEMBER_PANEL(false));}}
              className="mt-0 lg:mt-0 ml-[-50px] lg:ml-[-5px] mr-[0px] lg:hover:bg-slate-700 text-blue-400 lg:text-blue-400  w-[65px] h-[27px] text-[16px] text-center rounded-l-xl
                        border-[1px] border-blue-400 lg:border-gray-400 lg:border-gray-700 leading-[25px] shadow-md"
              >login</button>        
            <button onClick={()=> { dispatch(SET_LOGIN_WINDOW(false));dispatch(SET_MENU_BTN(false));dispatch(SET_MEMBER_PANEL(true));}}
              className="mt-0 lg:mt-0 lg:bg-slate-000 text-red-400 lg:text-white w-[65px] h-[27px] text-[16px] text-center rounded-r-xl
                         border-[1px] border-red-400 lg:border-gray-400 lg:border-gray-700 lg:hover:bg-slate-700 leading-[25px] shadow-md"
              >sign up</button>
          </>
        }
        <Link onClick={()=>{
