...
export default function Login() {
  ...
  return (
		<div className="absolute border-stone-400 border-[1px] bg-gray-100  w-full lg:w-[380px] lg:mt-10 top-[140px] lg:top-[200px] p-5 h-58 shadow-2xl z-10 rounded left-[50%] translate-x-[-50%]">
