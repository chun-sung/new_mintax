...
export default function MemPanel({mode}) {
    ...
    { user?.member_panel == true ? 
        ...
        <div className={ mode == 'lightMode' ? "absolute border-stone-400 border-[1px] bg-white w-[320px] lg:w-[380px] pt-4 pb-6 lg:mt-10 lg:left-[20px] top-[70px] lg:top-[90px] lg:p-5 h-180 shadow-2xl z-50 rounded"
            : "absolute border-stone-400 border-[1px] bg-gray-500 w-[320px] lg:w-[380px] pt-4 pb-6 lg:mt-10 lg:left-[20px] top-[70px] lg:top-[90px] lg:p-5 h-180 shadow-2xl z-50 rounded"
        }>
            ...
            <div className="lg:ml-[20px] lg:w-96 mb-3">   
                <form>
                    <div className="relative sm:mb-0 flex-grow w-full mb-2 ml-[40px] lg:ml-[20px]">
                    ...
                    <div className="relative sm:mb-0 flex-grow w-full mt-2 ml-[31px] lg:ml-[8px]">
            ...
            <div className="mt-2 ml-[10px] lg:ml-[15px] text-center text-sm">
